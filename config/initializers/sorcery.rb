...
Rails.application.config.sorcery.configure do |config|
  ...
  # -- session timeout --                                             
  config.session_timeout = 1.hours                                     # how long in seconds to keep the session alive.
  ...
  config.user_config do |user|
    # -- core --
    user.username_attribute_name = :name                                        # change default username
    ...
    user.reset_password_mailer = LiteHome::UserMailer                                                          # mailer class. Needed.
    ...
    user.login_lock_time_period = 1.minutes                                           # how long the user should be
    ...
    user.activity_timeout = 3.minutes                                                 # how long since last activity is
  ...
  config.user_class = LiteHome::User                                                          # define which model authenticates
                                                                                      # with sorcery.
end
